...
flowchart TD
    ...
    subgraph client["odoo-mcp-client (MIT)"]
        ...
        skills["odoo-ai-agents<br/>43 skills / 9 agents / 9 commands"]
...
|--------|-----------|--------|
| **[`odoo-ai-agents`](plugins/odoo-ai-agents/)** | The full Odoo AI workforce toolkit: **43 skills + 9 agents + 9 commands** across 9 personas, plus **12 declarative workflows** and the drive-to-done orchestration harness. Depends on `odoo-semantic-mcp` (auto-installed). | [README](plugins/odoo-ai-agents/README.md) |
