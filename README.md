...
flowchart TD
    ...
    subgraph client["odoo-mcp-client (MIT)"]
        ...
        skills["odoo-ai-agents<br/>45 skills / 11 agents / 9 commands"]
...
|--------|-----------|--------|
| **[`odoo-ai-agents`](plugins/odoo-ai-agents/)** | The full Odoo AI workforce toolkit: **45 skills + 11 agents + 9 commands** across 9 personas, plus **12 declarative workflows** and the drive-to-done orchestration harness. Includes instance lifecycle ops (create/drop/init/update/run-tests for any Odoo series v8+). Depends on `odoo-semantic-mcp` (auto-installed). | [README](plugins/odoo-ai-agents/README.md) |
