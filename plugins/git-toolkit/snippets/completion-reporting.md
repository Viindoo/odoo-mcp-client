...
and the presence of a messaging tool in your toolset is not an instruction to try. Keep the report
compact: a summary, the status, and the findings-file path; never diff hunks or file contents.
