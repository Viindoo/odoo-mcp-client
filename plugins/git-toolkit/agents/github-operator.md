...
Write the findings file first, then emit this result block (plus the findings-file path and status)
as your final message and stop - never send it to anyone, never end on a bare tool call or plain
text: `${CLAUDE_PLUGIN_ROOT}/snippets/completion-reporting.md`.
