...
description: >
  ...
  "lỗi console Odoo". Routing: RATE a working screen (aesthetics/a11y/perf) → odoo-ui-review;
  compare two builds for drift → odoo-visual-regression; demo video → odoo-demo-recording; write
  the fix → odoo-frontend-coding; static code audit → odoo-code-review
---
...
- **Rating a working screen** (aesthetics, a11y, performance verdict) → use `odoo-ui-review`
