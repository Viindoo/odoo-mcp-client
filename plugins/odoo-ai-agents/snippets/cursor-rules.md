...
- "inspect test class" → `test_class_inspect` - Inspect a TestClass or TestHelper by name: base chain (INHERITS_TEST), setUpClass fixtures, test methods with assert counts, and subclassed-by list.
