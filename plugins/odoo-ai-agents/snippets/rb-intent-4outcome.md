...
| # | Name | Signal | Action |
|---|---|---|---|
| (a) | **Already satisfied** | Base HEAD already ships the behavior; re-applying would duplicate it | Skip the commit - invoke the `git-toolkit:git-ops` skill to run "rebase --skip"; record reason in `rebase-log.md` |
